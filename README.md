...
Requires [Hammerspoon](https://www.hammerspoon.org/) and Reason 14, therefore macOS 11.0 or later is also required. In theory, an older version of Hammerspoon with as old as macOS 10.13 should be fine, but this is untested.
